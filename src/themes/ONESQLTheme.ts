...
export const ONESQLMonarchLanguage: monaco.languages.IMonarchLanguage = {
  ...
  tokenizer: {
    root: [
      ...
      // 字段 - 使用零宽断言替代 \\b
      // 定义标识符字符集（字母、数字、下划线、CJK范围）
      // 注意：正则表达式字面量中 \u 需要写为 \u，但在 new RegExp 字符串中需要 \\u
      [/(?<![A-Za-z0-9_\\u4E00-\\u9FFF])标题(?![A-Za-z0-9_\\u4E00-\\u9FFF])/, 'field'],
      [/(?<![A-Za-z0-9_\\u4E00-\\u9FFF])创建时间(?![A-Za-z0-9_\\u4E00-\\u9FFF])/, 'field'],
      [/(?<![A-Za-z0-9_\\u4E00-\\u9FFF])创建者(?![A-Za-z0-9_\\u4E00-\\u9FFF])/, 'field'],
      [/(?<![A-Za-z0-9_\\u4E00-\\u9FFF])更新时间(?![A-Za-z0-9_\\u4E00-\\u9FFF])/, 'field'],
      [/(?<![A-Za-z0-9_\\u4E00-\\u9FFF])工作项类型(?![A-Za-z0-9_\\u4E00-\\u9FFF])/, 'field'],
      [/(?<![A-Za-z0-9_\\u4E00-\\u9FFF])子工作项类型(?![A-Za-z0-9_\\u4E00-\\u9FFF])/, 'field'],
      [/(?<![A-Za-z0-9_\\u4E00-\\u9FFF])所属项目(?![A-Za-z0-9_\\u4E00-\\u9FFF])/, 'field'],
      [/(?<![A-Za-z0-9_\\u4E00-\\u9FFF])处理结果(?![A-Za-z0-9_\\u4E00-\\u9FFF])/, 'field'],
      [/(?<![A-Za-z0-9_\\u4E00-\\u9FFF])发布进度(?![A-Za-z0-9_\\u4E00-\\u9FFF])/, 'field'],
      [/(?<![A-Za-z0-9_\\u4E00-\\u9FFF])发布日期(?![A-Za-z0-9_\\u4E00-\\u9FFF])/, 'field'],
      [/(?<![A-Za-z0-9_\\u4E00-\\u9FFF])负责人(?![A-Za-z0-9_\\u4E00-\\u9FFF])/, 'field'],
      [/(?<![A-Za-z0-9_\\u4E00-\\u9FFF])故事点(?![A-Za-z0-9_\\u4E00-\\u9FFF])/, 'field'],
      [/(?<![A-Za-z0-9_\\u4E00-\\u9FFF])关联发布(?![A-Za-z0-9_\\u4E00-\\u9FFF])/, 'field'],
      [/(?<![A-Za-z0-9_\\u4E00-\\u9FFF])所属史诗(?![A-Za-z0-9_\\u4E00-\\u9FFF])/, 'field'],
      [/(?<![A-Za-z0-9_\\u4E00-\\u9FFF])ID(?![A-Za-z0-9_\\u4E00-\\u9FFF])/, 'field'],
      [/(?<![A-Za-z0-9_\\u4E00-\\u9FFF])截止日期(?![A-Za-z0-9_\\u4E00-\\u9FFF])/, 'field'],
      [/(?<![A-Za-z0-9_\\u4E00-\\u9FFF])解决者(?![A-Za-z0-9_\\u4E00-\\u9FFF])/, 'field'],
      [/(?<![A-Za-z0-9_\\u4E00-\\u9FFF])缺陷类型(?![A-Za-z0-9_\\u4E00-\\u9FFF])/, 'field'],
      [/(?<![A-Za-z0-9_\\u4E00-\\u9FFF])是否线上缺陷(?![A-Za-z0-9_\\u4E00-\\u9FFF])/, 'field'],
      [/(?<![A-Za-z0-9_\\u4E00-\\u9FFF])所属产品(?![A-Za-z0-9_\\u4E00-\\u9FFF])/, 'field'],
      [/(?<![A-Za-z0-9_\\u4E00-\\u9FFF])所属迭代(?![A-Za-z0-9_\\u4E00-\\u9FFF])/, 'field'],
      [/(?<![A-Za-z0-9_\\u4E00-\\u9FFF])描述(?![A-Za-z0-9_\\u4E00-\\u9FFF])/, 'field'],
