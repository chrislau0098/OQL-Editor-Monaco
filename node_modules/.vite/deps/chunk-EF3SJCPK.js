...
var TRACK_DISPOSABLES, disposableTracker, _DisposableStore, DisposableStore, _Disposable, Disposable, MutableDisposable, RefCountedDisposable, ImmortalReference, DisposableMap;
var init_lifecycle = __esm({
  "node_modules/monaco-editor/esm/vs/base/common/lifecycle.js"() {
    ...
    DisposableStore = _DisposableStore;
    _Disposable = class _Disposable {
      constructor() {
    ...
    MutableDisposable = class {
      ...
      set value(value) {
        ...
        (_a6 = this._value) == null ? void 0 : _a6.dispose();
        if (value) {
    ...
    DisposableMap = class {
      ...
      set(key, value, skipDisposeOnOverwrite = false) {
        ...
        if (!skipDisposeOnOverwrite) {
          (_a6 = this._store.get(key)) == null ? void 0 : _a6.dispose();
        }
...
var init_event = __esm({
  "node_modules/monaco-editor/esm/vs/base/common/event.js"() {
    ...
    _EventProfiling = class _EventProfiling {
      constructor(name) {
    ...
    _LeakageMonitor = class _LeakageMonitor {
      ...
      dispose() {
        var _a6;
        (_a6 = this._stacks) == null ? void 0 : _a6.clear();
      }
    ...
    LeakageMonitor = _LeakageMonitor;
    ...
    Emitter = class {
      constructor(options) {
        ...
        this._leakageMon = _globalLeakWarningThreshold > 0 || ((_a6 = this._options) == null ? void 0 : _a6.leakWarningThreshold) ? new LeakageMonitor((options == null ? void 0 : options.onListenerError) ?? onUnexpectedError, ((_b2 = this._options) == null ? void 0 : _b2.leakWarningThreshold) ?? _globalLeakWarningThreshold) : void 0;
        this._perfMon = ((_c = this._options) == null ? void 0 : _c._profName) ? new EventProfiling(this._options._profName) : void 0;
        this._deliveryQueue = (_d = this._options) == null ? void 0 : _d.deliveryQueue;
      }
      dispose() {
        var _a6, _b2, _c, _d;
        if (!this._disposed) {
          this._disposed = true;
          if (((_a6 = this._deliveryQueue) == null ? void 0 : _a6.current) === this) {
            ...
            if (_enableDisposeWithListenerWarning) {
              ...
              queueMicrotask(() => {
                forEachListener(listeners, (l) => {
                  var _a7;
                  return (_a7 = l.stack) == null ? void 0 : _a7.print();
                });
              });
            }
          ...
          (_c = (_b2 = this._options) == null ? void 0 : _b2.onDidRemoveLastListener) == null ? void 0 : _c.call(_b2);
      ...
      get event() {
        this._event ?? (this._event = (callback, thisArgs, disposables) => {
          ...
          if (this._leakageMon && this._size > this._leakageMon.threshold ** 2) {
            ...
            const errorHandler2 = ((_a6 = this._options) == null ? void 0 : _a6.onListenerError) || onUnexpectedError;
            errorHandler2(error);
          ...
          if (!this._listeners) {
            (_c = (_b2 = this._options) == null ? void 0 : _b2.onWillAddFirstListener) == null ? void 0 : _c.call(_b2, this);
            this._listeners = contained;
            (_e = (_d = this._options) == null ? void 0 : _d.onDidAddFirstListener) == null ? void 0 : _e.call(_d, this);
          ...
          if (_listenerFinalizers) {
            ...
            _listenerFinalizers.register(result, (match == null ? void 0 : match[2]) ?? stack2, result);
          }
          return result;
        });
        return this._event;
      ...
      _removeListener(listener) {
        var _a6, _b2, _c, _d;
        (_b2 = (_a6 = this._options) == null ? void 0 : _a6.onWillRemoveListener) == null ? void 0 : _b2.call(_a6, this);
        if (!this._listeners) {
          return;
        }
        if (this._size === 1) {
      ...
      fire(event) {
        var _a6, _b2, _c, _d;
        if ((_a6 = this._deliveryQueue) == null ? void 0 : _a6.current) {
    ...
    EventMultiplexer = class {
      ...
      unhook(e) {
        var _a6;
        (_a6 = e.listener) == null ? void 0 : _a6.dispose();
        e.listener = null;
      }
      dispose() {
        var _a6;
        ...
        return (listener, thisArgs, disposables) => {
          return event((i) => {
            ...
            if (reduceData.buffers.length === 0) {
              data.buffers.push(() => {
                reduceData.reducedResult ?? (reduceData.reducedResult = initial ? reduceData.items.reduce(reduce, initial) : reduceData.items.reduce(reduce));
...
function lookupMessage(index, fallback) {
  var _a6;
  const message = (_a6 = getNLSMessages()) == null ? void 0 : _a6[index];
...
var LANGUAGE_DEFAULT, _isWindows, _isMacintosh, _isLinux, _isLinuxSnap, _isNative, _isWeb, _isElectron, _isIOS, _isCI, _isMobile, _locale, _language, _platformLocale, _translationsConfigFile, _userAgent, $globalThis, nodeProcess, _a, _a2, isElectronProcess, isElectronRenderer, _a3, _platform, isWindows, isMacintosh, isLinux, isNative, isWeb, isWebWorker, webWorkerOrigin, isIOS, isMobile, userAgent, language, setTimeout0IsFaster, setTimeout0, OS, _isLittleEndian, _isLittleEndianComputed, isChrome, isFirefox, isSafari, isEdge, isAndroid;
var init_platform = __esm({
  "node_modules/monaco-editor/esm/vs/base/common/platform.js"() {
    ...
    isElectronProcess = typeof ((_a2 = nodeProcess == null ? void 0 : nodeProcess.versions) == null ? void 0 : _a2.electron) === "string";
    isElectronRenderer = isElectronProcess && (nodeProcess == null ? void 0 : nodeProcess.type) === "renderer";
    if (typeof nodeProcess === "object") {
      ...
      if (rawNlsConfig) {
        try {
          ...
          _translationsConfigFile = (_a3 = nlsConfig.languagePack) == null ? void 0 : _a3.translationsConfigFile;
        } catch (e) {
        }
      }
      _isNative = true;
...
var _formatRegexp, CodePointIterator, GraphemeIterator, CONTAINS_RTL, IS_BASIC_ASCII, UNUSUAL_LINE_TERMINATORS, UTF8_BOM_CHARACTER, _GraphemeBreakTree, GraphemeBreakTree, noBreakWhitespace, _AmbiguousCharacters, AmbiguousCharacters, _InvisibleCharacters, InvisibleCharacters;
var init_strings = __esm({
  "node_modules/monaco-editor/esm/vs/base/common/strings.js"() {
    ...
    _GraphemeBreakTree = class _GraphemeBreakTree {
      static getInstance() {
    ...
    GraphemeBreakTree = _GraphemeBreakTree;
    noBreakWhitespace = " ";
    _AmbiguousCharacters = class _AmbiguousCharacters {
    ...
    AmbiguousCharacters = _AmbiguousCharacters;
    _InvisibleCharacters = class _InvisibleCharacters {
      static getRawData() {
...
var safeProcess, vscodeGlobal, _a4, cwd, env, platform;
var init_process = __esm({
  "node_modules/monaco-editor/esm/vs/base/common/process.js"() {
    ...
    } else if (typeof process !== "undefined" && typeof ((_a4 = process == null ? void 0 : process.versions) == null ? void 0 : _a4.node) === "string") {
      safeProcess = {
        get platform() {
...
var Schemas, connectionTokenQueryName, RemoteAuthoritiesImpl, RemoteAuthorities, VSCODE_AUTHORITY, _FileAccessImpl, FileAccessImpl, FileAccess, COI;
var init_network = __esm({
  "node_modules/monaco-editor/esm/vs/base/common/network.js"() {
    ...
    _FileAccessImpl = class _FileAccessImpl {
      /**
    ...
    FileAccessImpl = _FileAccessImpl;
...
var _StringSHA1, StringSHA1;
var init_hash = __esm({
  "node_modules/monaco-editor/esm/vs/base/common/hash.js"() {
    init_strings();
    _StringSHA1 = class _StringSHA1 {
      // 80 * 4 = 320
      constructor() {
        this._h0 = 1732584193;
        this._h1 = 4023233417;
  ...
  "node_modules/monaco-editor/esm/vs/base/common/cancellation.js"() {
    ...
    CancellationTokenSource = class {
      ...
      dispose(cancel = false) {
        ...
        (_a6 = this._parentListener) == null ? void 0 : _a6.dispose();
        if (!this._token) {
  ...
  "node_modules/monaco-editor/esm/vs/editor/common/tokenizationRegistry.js"() {
    ...
    TokenizationRegistry = class {
      ...
      registerFactory(languageId, factory) {
        var _a6;
        (_a6 = this._factories.get(languageId)) == null ? void 0 : _a6.dispose();
...
var Token, TokenizationResult, EncodedTokenizationResult, HoverVerbosityAction, CompletionItemKinds, InlineCompletionTriggerKind, SelectedSuggestionInfo, DocumentPasteTriggerKind, SignatureHelpTriggerKind, DocumentHighlightKind, symbolKindNames, SymbolKinds, _FoldingRangeKind, FoldingRangeKind, NewSymbolNameTag, NewSymbolNameTriggerKind, Command, InlayHintKind, LazyTokenizationSupport, TokenizationRegistry2, TreeSitterTokenizationRegistry, InlineEditTriggerKind;
var init_languages = __esm({
  "node_modules/monaco-editor/esm/vs/editor/common/languages.js"() {
    ...
    _FoldingRangeKind = class _FoldingRangeKind {
      /**
    ...
    FoldingRangeKind = _FoldingRangeKind;
...
var _a5, _b, ResourceMapEntry, _ResourceMap, ResourceMap, LinkedMap, Cache, LRUCache, BidirectionalMap, SetMap;
var init_map = __esm({
  "node_modules/monaco-editor/esm/vs/base/common/map.js"() {
    ...
    _ResourceMap = class _ResourceMap {
      ...
      get(resource) {
        var _a6;
        return (_a6 = this.map.get(this.toKey(resource))) == null ? void 0 : _a6.value;
      }
      has(resource) {
      ...
      *[(_a5 = Symbol.toStringTag, Symbol.iterator)]() {
    ...
    LinkedMap = class {
      ...
      get first() {
        var _a6;
        return (_a6 = this._head) == null ? void 0 : _a6.value;
      }
      get last() {
        var _a6;
        return (_a6 = this._tail) == null ? void 0 : _a6.value;
      }
      has(key) {
...
var _MonotonousArray, MonotonousArray;
var init_arraysFind = __esm({
  "node_modules/monaco-editor/esm/vs/base/common/arraysFind.js"() {
    _MonotonousArray = class _MonotonousArray {
      constructor(_array) {
        this._array = _array;
    ...
    MonotonousArray = _MonotonousArray;
  }
});
...
var _TextLength, TextLength;
var init_textLength = __esm({
  "node_modules/monaco-editor/esm/vs/editor/common/core/textLength.js"() {
    init_position();
    init_range();
    _TextLength = class _TextLength {
...
var CompareResult, numberComparator, booleanComparator, ArrayQueue, _CallbackIterable, CallbackIterable, Permutation;
var init_arrays = __esm({
  "node_modules/monaco-editor/esm/vs/base/common/arrays.js"() {
    ...
    _CallbackIterable = class _CallbackIterable {
      constructor(iterate) {
    ...
    CallbackIterable = _CallbackIterable;
...
var RGBA, HSLA, HSVA, _Color, Color;
...
var Throttler, timeoutDeferred, microtaskDeferred, Delayer, ThrottledDelayer, TimeoutTimer, IntervalTimer, RunOnceScheduler, runWhenGlobalIdle, _runWhenIdle, AbstractIdleValue, GlobalIdleValue, DeferredPromise, Promises, _AsyncIterableObject, AsyncIterableObject, CancelableAsyncIterableObject;
var init_async = __esm({
  "node_modules/monaco-editor/esm/vs/base/common/async.js"() {
    ...
    Delayer = class {
      ...
      trigger(task, delay = this.defaultDelay) {
        ...
        const fn = () => {
          var _a6;
          this.deferred = null;
          (_a6 = this.doResolve) == null ? void 0 : _a6.call(this, null);
        };
      ...
      isTriggered() {
        var _a6;
        return !!((_a6 = this.deferred) == null ? void 0 : _a6.isTriggered());
      }
      cancel() {
        var _a6;
        this.cancelTimeout();
        if (this.completionPromise) {
          (_a6 = this.doReject) == null ? void 0 : _a6.call(this, new CancellationError());
          this.completionPromise = null;
        }
      }
      cancelTimeout() {
        var _a6;
        (_a6 = this.deferred) == null ? void 0 : _a6.dispose();
        this.deferred = null;
      }
      dispose() {
        this.cancel();
    ...
    IntervalTimer = class {
      ...
      cancel() {
        var _a6;
        (_a6 = this.disposable) == null ? void 0 : _a6.dispose();
        this.disposable = void 0;
      }
    ...
    RunOnceScheduler = class {
      ...
      doRun() {
        var _a6;
        (_a6 = this.runner) == null ? void 0 : _a6.call(this);
      }
    };
    (function() {
    ...
    DeferredPromise = class {
      get isRejected() {
        var _a6;
        return ((_a6 = this.outcome) == null ? void 0 : _a6.outcome) === 1;
      }
      get isSettled() {
        return !!this.outcome;
      }
    ...
    _AsyncIterableObject = class _AsyncIterableObject {
      ...
      [Symbol.asyncIterator]() {
        ...
        return {
          ...
          return: async () => {
            var _a6;
            (_a6 = this._onReturn) == null ? void 0 : _a6.call(this);
            return { done: true, value: void 0 };
          }
        };
      }
    ...
    AsyncIterableObject = _AsyncIterableObject;
...
var DetailedLineRangeMapping = class _DetailedLineRangeMapping extends LineRangeMapping {
  ...
  flip() {
    var _a6;
    return new _DetailedLineRangeMapping(this.modified, this.original, (_a6 = this.innerChanges) == null ? void 0 : _a6.map((c) => c.flip()));
  }
...
var LegacyLinesDiffComputer = class {
  computeDiff(originalLines, modifiedLines, options) {
    ...
    for (const c of result.changes) {
      ...
      let change = new DetailedLineRangeMapping(originalRange, modifiedRange, (_a6 = c.charChanges) == null ? void 0 : _a6.map((c2) => new RangeMapping(new Range(c2.originalStartLineNumber, c2.originalStartColumn, c2.originalEndLineNumber, c2.originalEndColumn), new Range(c2.modifiedStartLineNumber, c2.modifiedStartColumn, c2.modifiedEndLineNumber, c2.modifiedEndColumn))));
      if (lastChange) {
...
function findSectionHeaders(model, options) {
  var _a6;
  let headers = [];
  if (options.findRegionSectionHeaders && ((_a6 = options.foldingRules) == null ? void 0 : _a6.markers)) {
  ...
  static computeDiff(originalTextModel, modifiedTextModel, options, algorithm) {
    ...
    function getLineChanges(changes) {
      return changes.map((m) => {
        var _a6;
        return [m.original.startLineNumber, m.original.endLineNumberExclusive, m.modified.startLineNumber, m.modified.endLineNumberExclusive, (_a6 = m.innerChanges) == null ? void 0 : _a6.map((m2) => [
...
//# sourceMappingURL=chunk-EF3SJCPK.js.map
